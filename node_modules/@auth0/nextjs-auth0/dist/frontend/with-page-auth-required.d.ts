 ...
 * @category Client
 */
export declare type WithPageAuthRequired = <P extends WithPageAuthRequiredProps>(Component: ComponentType<P & UserProps>, options?: WithPageAuthRequiredOptions) => React.FC<P>;
/**
 * @ignore
 */
