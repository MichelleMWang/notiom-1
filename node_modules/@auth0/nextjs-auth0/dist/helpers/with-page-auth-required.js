...
var get_server_side_props_wrapper_1 = tslib_1.__importDefault(require("./get-server-side-props-wrapper"));
/**
 * @ignore
 */
function withPageAuthRequiredFactory(loginUrl, getSessionCache) {
    ...
    return function (optsOrComponent, csrOpts) {
        ...
        var getServerSidePropsWrapper = get_server_side_props_wrapper_1.default(getSessionCache);
        return getServerSidePropsWrapper(function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        session = sessionCache.get(ctx.req, ctx.res);
                    ...
                    case 2:
                        if (ret.props instanceof Promise) {
                            return [2 /*return*/, tslib_1.__assign(tslib_1.__assign({}, ret), { props: ret.props.then(function (props) { return (tslib_1.__assign(tslib_1.__assign({}, props), { user: session.user })); }) })];
                        }
                        return [2 /*return*/, tslib_1.__assign(tslib_1.__assign({}, ret), { props: tslib_1.__assign(tslib_1.__assign({}, ret.props), { user: session.user }) })];
                }
            });
        }); });
    };
